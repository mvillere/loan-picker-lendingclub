...
public class Cfg {
	...
	public static enum T {
		...
		PURCHASE_LIMIT, IN_DEBUG, RUN_AS_SCHEDULER, CRON_EXPRESSION, CREATE_PORTFOLIO
	}
	...
	//0630 change to show all as true
	public static String LC_URL_LOAN_LIST = "https://api.lendingclub.com/api/investor/v1/loans/listing?showAll=true";
